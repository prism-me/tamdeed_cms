...
const languages = [
  { value: "english", label: "English", color: "#1A2C52 " },
  { value: "french", label: "French", color: "#1A2C52 " },
  { value: "spanish", label: "Spanish", color: "#1A2C52 " },
  { value: "russian", label: "Russian", color: "#1A2C52 " },
  { value: "italian", label: "Italian", color: "#1A2C52 " }
]

const colourStyles = {
  control: styles => ({ ...styles, backgroundColor: "white" }),
  option: (styles, { data, isDisabled, isFocused, isSelected }) => {
    const color = data.color ? chroma(data.color) : "#1A2C52 "
    return {
      ...styles,
      ...
      ":active": {
        ...styles[":active"],
        backgroundColor: !isDisabled && (isSelected ? data.color : "#1A2C52 ")
      }
    }
  },
  ...
  multiValueLabel: (styles, { data }) => ({
    ...styles,
    color: data.color ? data.color : "#1A2C52 "
  }),
  multiValueRemove: (styles, { data }) => ({
    ...styles,
    color: data.color,
    ":hover": {
      backgroundColor: data.color ? data.color : "#1A2C52 ",
      color: "white"
    }
  })
}

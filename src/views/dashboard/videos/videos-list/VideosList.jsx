  ...
  return (
    <div className="d-flex flex-wrap justify-content-between">
      <div className="add-new">
        <Button.Ripple
          color="primary"
          onClick={() => props.history.push("/experienceAgs/form")}
        >
          Add New
        </Button.Ripple>
      </div>
...
class VideosList extends React.Component {
        ...
        cell: (row) => (
          <p className="text-bold-500 mb-0">
            ...
            <MdEdit
              ...
              onClick={() => {
                this.props.history.push(`/experienceAgs/form/edit/${row._id}`);
              }}
  ...
  getVideosList = () => {
    API.get("/exp_and_life")
      .then((response) => {
        this.setState({
          data: response.data.data?.filter(x => x.type === "experience-with-ags"),
        });
      })
      .catch();
  };
  ...
  render() {
    ...
    return (
      <Card>
        <CardHeader>
          <CardTitle>Experience Ags Difference List</CardTitle>
        </CardHeader>

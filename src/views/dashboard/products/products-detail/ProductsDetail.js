...
import productImage from "../../../../assets/img/products/ProductOne.jpeg";
          ...
          <CardBody className="pb-0">
            <Row className="mb-5 mt-2">
              ...
              <Col md="7" sm="12">
                ...
                <hr />
                <p>
                  If you are exclusively pumping or will be away from your baby
                  eight or more hours a day, a double electric breast pump is a
                  worthwhile investment.ٖ
                </p>
                <p>
                  If you're only planning to pump occasionally, a manual or
                  single pump may be all you need. ... Some electric pumps
                  require an electric outlet while others require batteries.
                </p>
                <ul className="list-unstyled">
                  <li className="mb-50">
                    <SiZend size={15} />
                    <span className="align-middle ml-50">Size</span>
                  </li>
                  <li className="mb-50">
                    <FaProductHunt size={15} />
                    <span className="align-middle ml-50">
                      Category Id: 5241xyz214
                    </span>
                  </li>
                  <li className="mb-50">
                    <AiFillExclamationCircle size={15} />
                    <span className="align-middle  ml-50">Material: Glass</span>
                  </li>
                </ul>
                <hr />
                <h4>Colors</h4>

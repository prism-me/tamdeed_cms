...
const LifeAtAgsForm = (props) => {
    ...
    return (
        <>
            {console.log('videoData-1', videoData?.type)}
            <Card className="category-add-form">
                <CardHeader>
                    <CardTitle>Life At Ags {isEdit ? "Edit" : "Add"} Form</CardTitle>
                </CardHeader>
                <CardBody>
                    <Formik
                        initialValues={{
                    ...
                    >
                        {({ errors, touched }) => (
                            <Form>
                                ...
                                {
                                    console.log("videolink", videoData.video_link)
                                }
                                <Row>
                                    <Col sm={3}>
                                        <FormGroup className="mb-1">
...
export default withRouter(LifeAtAgsForm);

    ...
    <div className="d-flex flex-wrap justify-content-between">
      <div className="add-new">
        <Button.Ripple
          color="primary"
          onClick={() => {
            props.history.push("/StudentCare/form");
          }}
        >
          Add New
        </Button.Ripple>
...
class StudentCareList extends React.Component {
  state = {
    columns: [
      {
        name: "Name",
        ...
        cell: (row) => (
          <p className="text-bold-500 mb-0">
            ...
            <MdEdit
              ...
              onClick={() => {
                this.props.history.push(`/StudentCare/form/edit/${row._id}`);
              }}
  ...
  render() {
    ...
    return (
      <Card>
        <CardHeader>
          <CardTitle>Student Care List</CardTitle>
        </CardHeader>

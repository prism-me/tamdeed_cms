...
const initialObj = {
    name: "kindergarten-page",
    page_id: 6,
    slug: "kindergarten-page",
    content: {
        section1: {
            title: "",
            video_link: "",
...
const Kindergarten = () => {
    const [kindergartenData, setKindergartenData] = useState({ ...initialObj });
    ...
    const handleImageSelect = (e, index) => {
        if (e.target.checked) {
            ...
            if (isSection1 && !isSection2) {
                let updatedImage = { ...kindergartenData };
                updatedImage.content.section1.image = imagesData[index].url;
                setKindergartenData(updatedImage);
            ...
            // if (isPromoImage && !isSection1 && !section2 && !isSection5) {
            //     let updatedImage = { ...kindergartenData };
        ...
        API.get(`/pages`)
            .then((response) => {
                ...
                if (response.status === 200 || response.status === 201) {
                    let currentPage = response.data.data.find((x) => x.slug === "kindergarten-page");
                    ...
                    API.get(`/all_sections/${currentPage._id}`)
                        .then((res) => {
                            ...
                            setKindergartenData({ ...initialObj, content });
                        })
    ...
    const handlesection1OnChange = (e) => {
        let updatedValue = { ...kindergartenData };
        updatedValue.content.section1[e.target.name] = e.target.value;
        setKindergartenData(updatedValue);
    };
    ...
    //! --------------Handle Submit-------------
    const handleSubmit = () => {
        let updatedData = { ...kindergartenData, page_id: pageData._id };
                                                ...
                                                <CardBody>
                                                    <FormGroup className="mb-1">
                                                        ...
                                                        <Field
                                                            ...
                                                            value={kindergartenData?.content?.section1?.title}
                                                    ...
                                                    <FormGroup className="mb-1">
                                                        ...
                                                        <Field
                                                            ...
                                                            id="video_link"
                                                            onChange={handlesection1OnChange}
                                                            value={kindergartenData?.content?.section1?.video_link}
                                                            className={`form-control`}
                                                        />
                                                    </FormGroup>
                                                    <Row>
                                                        <Col sm={9}>
                                                            <div>
                                                                ...
                                                                <CKEditor
                                                                    ...
                                                                    data={
                                                                        kindergartenData?.content?.section1
                                                                            ?.description
                                                                    }
                                                                    onChange={(e) =>
                                                ...
                                                <CardBody>
                                                    <FormGroup className="mb-1">
                                                        ...
                                                        <Field
                                                            ...
                                                            value={kindergartenData?.content?.section2?.video_link}
                                                            className={`form-control`}
                                                        />
                                                    </FormGroup>
                                                    <Row>
                                                        <Col sm={9}>
                                                            <div>
                                                                ...
                                                                <CKEditor
                                                                    ...
                                                                    data={
                                                                        kindergartenData?.content?.section2
                                                                            ?.description
                                                                    }
                                                                    onChange={(e) =>
                                                        ...
                                                        <Col sm={12}>
                                                            <div>
                                                                ...
                                                                <CKEditor
                                                                    ...
                                                                    data={
                                                                        kindergartenData?.content?.section3
                                                                            ?.description
                                                                    }
                                                                    onChange={(e) =>
                                                        ...
                                                        <Col sm={12}>
                                                            <div>
                                                                ...
                                                                <CKEditor
                                                                    ...
                                                                    data={
                                                                        kindergartenData?.content?.section4
                                                                            ?.description
                                                                    }
                                                                    onChange={(e) =>
                                                ...
                                                <CardBody>
                                                    <FormGroup className="mb-1">
                                                        ...
                                                        <Field
                                                            ...
                                                            value={kindergartenData?.content?.section5?.video_link}
                                                            className={`form-control`}
                                                        />
                                                    </FormGroup>
                                                    <Row>
                                                        <Col sm={9}>
                                                            <div>
                                                                ...
                                                                <CKEditor
                                                                    ...
                                                                    data={
                                                                        kindergartenData?.content?.section5?.description
                                                                    }
                                                                    onChange={(e) =>
                                                        ...
                                                        <Col sm={3}>
                                                            <FormGroup className="">
                                                                ...
                                                                <div className="clearfix" />
                                                                <div className="img-preview-wrapper">
                                                                    {kindergartenData?.content?.section5
                                                                        ?.image !== "" && (
                                                                            <img
                                                                                src={
                                                                                    kindergartenData?.content?.section5
                                    ...
                                    <CardBody>
                                        <FormGroup className="">
                                            ...
                                            <Field
                                                ...
                                                value={kindergartenData?.content?.meta_details?.title}
                                                className={`form-control`}
                                            />
                                        </FormGroup>
                                        <div>
                                            ...
                                            <Input
                                                ...
                                                onChange={handleMetaOnChange}
                                                value={
                                                    kindergartenData?.content?.meta_details?.description
                                                }
                                            />
                                        </div>
                                        <div>
                                            ...
                                            <Input
                                                ...
                                                onChange={handleMetaOnChange}
                                                value={
                                                    kindergartenData?.content?.meta_details?.schema_markup
                                                }
                                            />
                                        </div>
                                    </CardBody>
                                                    ...
                                                    <CardBody>
                                                        <FormGroup className="mb-1">
                                                            ...
                                                            <Field
                                                                ...
                                                                value={
                                                                    kindergartenData?.content?.arabic?.section1
                                                                        ?.title
                                                                }
                                                                className={`form-control`}
                                                            />
                                                            ...
                                                            <Col sm={12}>
                                                                <div>
                                                                    ...
                                                                    <CKEditor
                                                                        ...
                                                                        data={
                                                                            kindergartenData?.content?.arabic
                                        ...
                                        <CardBody>
                                            <FormGroup className="">
                                                ...
                                                <Field
                                                    ...
                                                    value={
                                                        kindergartenData?.content?.arabic?.meta_details
                                                            ?.title
                                                    }
                                                    className={`form-control`}
                                                />
